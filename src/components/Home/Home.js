...
//       </div>
//       <h1 className="text-[22px] ss:text-[53px] lg:text-[61px] max-w-full ss:max-w-[800px] lg:max-w-[900px] py-5">
...
//         <a href="#" className="uppercase inline-block text-base ss:text-xl bg-primary hover:bg-white hover:text-primary border border-primary duration-500 rounded-full py-4 ss:py-8 px-12 ss:px-16 w-80 ss:w-auto font-bold text-white">
...
//           alt="main img"
//           className="w-[1200px] ml-[30px] sm:ml-[100px] ss:absolute ss:right-[-300px] ss:bottom-20 md:bottom-[-160px] md:right-[-230px] lg:top-0 lg:right-[-130px]"
//         />
//       </div>
//     </div>
//   </section>
...
const Home = () => (
  <section className="home">
    <div className="container">
      ...
      <div className="cta">
        <a href="#" className="cta-button">bepul darsga yoziling</a>
